  ...
  <head>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.html">Kionion<em>.</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="regis.html"><span>Reservation</span></a></li>
					</ul>	
				</div>
			</div>
	...
	<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Hand-crafted by <a href="http://gettemplates.co" target="_blank">Kion & co.</a></span>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_1.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p><span class="price cursive-font">2000</span></p>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_3.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2>Chicken Roll</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
							<p><span class="price cursive-font">500</span></p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_5.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2>Basil with Chicken</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
							<p><span class="price cursive-font">3000</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_6.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
							<p><span class="price cursive-font">5000</span></p>
						</div>
					</a>
				</div>
		...
		<div class="gtco-container text-center">
			<div class="display-t">
				<div class="display-tc">
					...
					<p>&mdash; Kion Doe, CEO of Kion Co.</p>
				</div>	
			</div>
		</div>
	</div>
		...
		<div class="gtco-container">
			<div class="row row-pb-md">
				...
				<div class="col-md-12 text-center">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							...
							<li><a href="#"><i class="icon-mail2"></i> info@Kion.co</a></li>
				...
				<div class="col-md-12 text-center copyright">
					<p><small class="block">&copy; 2019 Kionion. All Rights Reserved.</small> 
						<small class="block">Designed by <a href="http://Kionable.co/" target="_blank">Kionable.co</a> Demo Images: <a href="http://unsplash.com/" target="_blank">Unsplash</a></small></p>
				</div>
